...
import { baseMessenger,operationData } from "./types";

export class Messenger {

    _config : baseMessenger;

    /**
     * The Messenger class, constructor
     * @param {object} config Messenger's config
     */
    constructor(config : baseMessenger){
        this._config = config;
    }
     ...
     * @public
     */
    getMessage( oData? : operationData) : string {
        /**
     ...
     * @private
     */
     _constructMessage( oData : operationData ) : string{
...
// Messenger.prototype = Object.create(prototypeMessager);
